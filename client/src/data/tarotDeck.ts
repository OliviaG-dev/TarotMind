...
const MINOR_KEYWORDS: Record<string, string[][]> = {
  coupes: [
    ...
    ['célébration', 'amitié', 'partage'],
    ['repli', 'lassitude', 'réflexion'],
    ['deuil', 'perte', 'nostalgie'],
    ['enfance', 'souvenir', 'tendresse'],
    ['illusion', 'rêve', 'choix flou'],
    ['départ', 'abandon', 'quête'],
    ['satisfaction', 'vœu exaucé', 'plénitude'],
    ['bonheur familial', 'accomplissement', 'gratitude'],
    ['sensibilité', 'message', 'créativité'],
    ['romantisme', 'séduction', 'charme'],
    ['compassion', 'sagesse du cœur', 'empathie'],
    ['maturité émotionnelle', 'générosité', 'équilibre'],
  ],
  batons: [
    ['élan', 'inspiration', 'potentiel'],
    ['planification', 'ambition', 'décision'],
    ['expansion', 'vision', 'commerce'],
    ['fête', 'fondation', 'étape'],
    ['compétition', 'conflit', 'défi'],
    ['victoire', 'reconnaissance', 'fierté'],
    ['persévérance', 'défense', 'courage'],
    ['vitesse', 'mouvement', 'progression'],
    ['résilience', 'vigilance', 'endurance'],
    ['charge', 'responsabilité', 'surmenage'],
    ['aventure', 'enthousiasme', 'découverte'],
    ['passion', 'énergie', 'leadership'],
    ['charisme', 'confiance', 'détermination'],
    ['autorité', 'vision stratégique', 'entrepreneuriat'],
  ],
  epees: [
    ['vérité', 'clarté', 'percée'],
    ['indécision', 'blocage', 'compromis'],
    ['chagrin', 'rupture', 'séparation'],
    ['repos', 'récupération', 'pause'],
    ['défaite', 'humiliation', 'leçon'],
    ['transition', 'passage', 'soulagement'],
    ['ruse', 'stratégie', 'fuite'],
    ['prison mentale', 'impuissance', 'anxiété'],
    ['insomnie', 'culpabilité', 'inquiétude'],
    ['fin brutale', 'épuisement', 'limite'],
    ['perspicacité', 'curiosité', 'esprit vif'],
    ['communication', 'franchise', 'rapidité'],
    ['discernement', 'autorité intellectuelle', 'objectivité'],
    ['justice', 'logique', 'décision tranchée'],
  ],
  deniers: [
    ['opportunité', 'prospérité', 'début matériel'],
    ['équilibre', 'gestion', 'adaptation'],
    ['maîtrise', 'savoir-faire', 'collaboration'],
    ['sécurité', 'possession', 'contrôle'],
    ['précarité', 'isolement', 'épreuve'],
    ['générosité', 'partage', 'charité'],
    ['patience', 'investissement', 'croissance'],
    ['apprentissage', 'perfectionnement', 'rigueur'],
    ['indépendance', 'abondance', 'luxe'],
    ['héritage', 'famille', 'patrimoine'],
    ['étude', 'concentration', 'pragmatisme'],
    ['fiabilité', 'travail', 'méthodique'],
    ['confort', 'abondance', 'nature'],
    ['réussite matérielle', 'influence', 'stabilité'],
  ],
}
