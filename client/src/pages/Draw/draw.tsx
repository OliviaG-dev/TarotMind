...
export default function DrawPage() {
  ...
  return (
    <div className="draw-page">
      <header className="draw-page__intro">
        <div className="page-heading draw-page__heading">
          <span className="draw-page__heading-icon home__feature-icon-wrap">
            <FeatureIconCardsStar className="home__feature-icon" />
          </span>
          <h1 className="draw-page__title">Tirage</h1>
        </div>
            ...
            {SPREADS.map((s) => (
              <li key={s.id}>
                ...
                >
                  ...
                  />
                  <span className="draw-page__spread-radio" aria-hidden="true" />
                  ...
                  <span className="draw-page__spread-text">
                    ...
                    <span className="draw-page__spread-desc">{s.description}</span>
                  </span>
                </label>
              </li>
            ))}
